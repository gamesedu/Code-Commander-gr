...
Class.subclass('App', {
  ...
  loadLevel: function(difficulty, num) {
    ...
    document.getElementById("program").disabled = false; //jon 190522 re-enable program textarea
    this.overlay.hide();
    if (this.level) {
      this.level.unload();
    }
  ...
  runProgram: function() {
    ...
    document.getElementById("program").disabled = true; //jon 190522 disable program textarea
    this.overlay.hide();
