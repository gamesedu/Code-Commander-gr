...
Overlay.PAGES = {
  ...
  'welcome': function(p) {
    p.h1('Γειά σου ' + app.settings.get('name') + '!')
      ...
      .p('<BR>Μόλις γράψετε το πρόγραμμα πατήστε το κουμπί "Εκτέλεση" για να δείτε εαν δουλεύει σωστά.')//Once you have written your program, click the "Run Program" button to see if it works!
  ...
  'help-programming': function(p) {
    p.h1('ΒΟΗΘΕΙΑ')
      ...
      .p('Μπορείτε να χρησιμοποιήσετε τις παρακάτω εντολές (γράφετε μια εντολή σε κάθε σειρά):')
      ...
      .indent('<b>ΕΠΑΝΑΛΑΒΕ 5 [<BR>ΜΠΡΟΣΤΑ<BR>ΠΥΡ<BR>]</b> <i>: ΘΑ ΕΚΤΕΛΕΣΕΙ ΤΙΣ ΕΝΤΟΛΕΣ ΜΠΡΟΣΤΑ ΚΑΙ ΠΥΡ 5 ΦΟΡΕΣ</i>')
